...
const ContactInfo = () => {
  ...
  return (
    <article className="grid-container pb-5">
      <div className="grid place-items-center place-content-center text-center p-7 gap-12">
        <Image
          ...
          width={700}
          height={0}
          className="w-10/12 sm:w-3/4 sm:h-[220px] h-fit object-contain"
        />
        <header className="space-y-2 grid place-items-center">
          <h3 className="grid-headtext">Contact Me</h3>
          <p className="grid-subtext">
            Looking to get in touch? Whether you have a project in mind, need
            assistance, or just want to connect, I’m here to help
          </p>
          <div
